...
для распознавания цифр из базы MNIST. Режим обучения - пакетный.
...
### main.py
Парсит аргументы командной строки, запускат нужную сеть или сравнивает их.
